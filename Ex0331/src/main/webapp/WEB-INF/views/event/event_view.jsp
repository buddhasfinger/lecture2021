...
//  		html +='</li>';
 ...
 /*댓글등록*/
 	function commentWrite(commentNo,id,commentDate,conmmentContent){
 		alert('댓글쓰기');
 		var html ="";
 		var id = "${session_id}";
 		$.ajax({
...
//  				html +='onclick="commentUpdate('+data.commentNo+','+data.id+','+data.commentDate+','+data.conmmentContent')">';
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								...
								<p class="password" >비밀번호&nbsp;&nbsp;<input type="password" id="commentPw" name="commentPw" class="replynum" /></p>
